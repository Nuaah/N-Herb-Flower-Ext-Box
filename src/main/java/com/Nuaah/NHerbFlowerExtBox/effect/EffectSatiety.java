...
public class EffectSatiety extends MobEffect {

    private static final ResourceLocation ICON = new ResourceLocation(NHerbFlowerExtBox.MOD_ID, "textures/gui/effect/satiety.png");

    public EffectSatiety() {
        super(MobEffectCategory.BENEFICIAL, 0xC95533);
    }
