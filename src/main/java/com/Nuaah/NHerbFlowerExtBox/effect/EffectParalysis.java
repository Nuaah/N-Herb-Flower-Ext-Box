...
public class EffectParalysis extends MobEffect {
    ...
    private static final ResourceLocation ICON = new ResourceLocation(NHerbFlowerExtBox.MOD_ID, "textures/gui/effect/paralysis.png");

    public EffectParalysis() {
        super(MobEffectCategory.HARMFUL, 0xFFBA21);
    }
