...
public class EffectColorblind extends MobEffect {

    private static final ResourceLocation ICON = new ResourceLocation(NHerbFlowerExtBox.MOD_ID, "textures/gui/effect/colorblind.png");

    public EffectColorblind() {
