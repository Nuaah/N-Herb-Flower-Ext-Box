...
public class EffectStagger extends MobEffect {

    private static final ResourceLocation ICON = new ResourceLocation(NHerbFlowerExtBox.MOD_ID, "textures/gui/effect/stagger.png");

    public EffectStagger() {
        super(MobEffectCategory.HARMFUL, 0x2B3590);
    }
