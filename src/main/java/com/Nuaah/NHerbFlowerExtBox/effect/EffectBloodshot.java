...
public class EffectBloodshot extends MobEffect {

    private static final ResourceLocation ICON = new ResourceLocation(NHerbFlowerExtBox.MOD_ID, "textures/gui/effect/bloodshot.png");

    public EffectBloodshot() {
