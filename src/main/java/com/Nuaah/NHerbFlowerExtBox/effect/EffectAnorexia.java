...
public class EffectAnorexia extends MobEffect {

    private static final ResourceLocation ICON = new ResourceLocation(NHerbFlowerExtBox.MOD_ID, "textures/gui/effect/anorexia.png");

    public EffectAnorexia() {
