...
public class EffectConfusion extends MobEffect {

    private static final ResourceLocation ICON = new ResourceLocation(NHerbFlowerExtBox.MOD_ID, "textures/gui/effect/confusion.png");

    public EffectConfusion() {
        super(MobEffectCategory.HARMFUL, 0xCA43C7);
    }
