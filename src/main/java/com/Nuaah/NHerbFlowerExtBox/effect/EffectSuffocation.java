...
public class EffectSuffocation extends MobEffect {

    private static final ResourceLocation ICON = new ResourceLocation(NHerbFlowerExtBox.MOD_ID, "textures/gui/effect/suffocation.png");

    public EffectSuffocation() {
        super(MobEffectCategory.HARMFUL, 0xFF1432);
    }
